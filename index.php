...
*/
	...
	{		
		...
		break;
		case "sondage" :
			include("templates/sondage.php");
		break;
		case "inscription" :
			include("templates/inscription.php");
			break;
		case "creationsondage" :
			include("templates/creationsondage.php");
			break;
		case "utilisateur" :
			include("templates/utilisateur.php");
			break;
		case "reponse" :
			include("templates/réponse.php");
			break;
		case "compte" :
			include("templates/monCompte.php");
			break;
		case "ami" :
			include("templates/ami.php");
			break;
		case "admin" :
			include("templates/administration.php");
			break;
		case "abonne" :
			include("templates/abonne.php");
			break;
		case "edition" :
